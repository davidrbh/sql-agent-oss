...
Para una explicación detallada de la arquitectura, consulta [docs/01_architecture/overview.md](01_architecture/overview.md).
...
Para una comprensión más profunda del proyecto, su arquitectura, cómo extenderlo y configurar características avanzadas, utiliza el menú de navegación.
